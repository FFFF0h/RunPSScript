...
namespace System.Processes
{
    ...
    public class ScriptEngine
    {
        ...
        public enum Options : int
        {
            ...
            UsesAdditionalParametersFirst = 0x0010,
        }
                ...
                return new ScriptEngine[]
                    {
                        ...
                        new ScriptEngine(Language.PowerShell, null, "-NoP -Ex ByPass -NonI -NoL -C -", ".psh",
                                         Options.UsesStandardInputScript | Options.UsesAdditionalParametersFirst),
        ...
        /// <summary>
        /// Returns true if the parameters should be fed into first in command arguments
        /// </summary>
        public bool UsesAdditionalParametersFirst { get { return ((RunOptions & Options.UsesAdditionalParametersFirst) == Options.UsesAdditionalParametersFirst); } }
		...
		private TempFile CodeCompiler<TCompiler>(string script) where TCompiler : CodeDomProvider, new()
        {
            ...
            args.ReferencedAssemblies.Add("System.Management.dll");
