...
namespace System.Processes
{
    ...
    public class ScriptRunner : IRunner, IDisposable
    {
        ...
        /// </summary>
        public ScriptRunner(ScriptEngine.Language language, NetworkCredential credential, bool elevatedPrivileges, string script)
            : this(ScriptEngine.GetDefaults(language), credential, elevatedPrivileges, script)
        { }

        /// <summary>
        /// Creates a runnable script with the specified engine parameters
        /// </summary>
        public ScriptRunner(ScriptEngine engine, NetworkCredential credential, bool elevatedPrivileges, string script)
        {
			_engine = engine;
			...
			_runner = new ProcessRunner(engine.Executable, credential, elevatedPrivileges, engine.UsesAdditionalParametersFirst, _arguments);
        }
        ...
        /// <summary> Returns the underlying process process runner </summary>
        public ProcessRunner ProcessRunner { get { return _runner;  } }
